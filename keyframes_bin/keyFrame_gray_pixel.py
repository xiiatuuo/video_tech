...
def extractKeyFrames(video_file, out_path):
    try:
        ...
        print keyframe_no_list
        print selected_keyframe_no_list

        # output result keyframes
        #videoCommon.saveFramesAsPngs(cap, selected_keyframe_no_list, out_path)
        videoCommon.saveFramesAsPngs(cap, keyframe_no_list, out_path)
